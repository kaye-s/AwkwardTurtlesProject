    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instructor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Course_Instructor', to='TAScheduler.instructor')),
                ('super_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_supervisor', to='TAScheduler.supervisor')),
                ('course_ta', models.ManyToManyField(to='TAScheduler.ta')),
            ],
        ),
        migrations.CreateModel(
            name='Section',
            fields=[
                ...
                ('section_type', models.CharField(max_length=15)),
                ('section_num', models.IntegerField(unique=True)),
                ('days_of_week', models.CharField(max_length=7)),
                ('section_startTime', models.TimeField()),
                ('section_endTime', models.TimeField()),
                ('lecture_instructor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Lecture_Instructor', to='TAScheduler.instructor')),
                ...
                ('section_ta', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Section_TA', to='TAScheduler.ta')),
            ],
        ),
        migrations.CreateModel(
            name='User',
