...
from TAScheduler.models import Section, Course, Supervisor, TA, Instructor
...
class CreateSectionsTests(TestCase):
    def setUp(self):
        ...
        self.ta_user = TA.objects.create(user=self.ta_user)
    ...
    def test_create_section_no_error(self):
        ...
        data = {
            'section_num': '733',
            'course_id': self.test_course_valid.course_id,
            'action': 'createSection',
            "section_ta":self.ta_user.user
